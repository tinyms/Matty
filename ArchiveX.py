...
#(base64.b64encode(uuid.uuid4().bytes + uuid.uuid4().bytes)).decode("utf-8")
ws_settings["cookie_secret"] = "askgpoi45345j2l34j6lkjasljdfpajsfd"
...
if web_configs:
    for web_config in web_configs:
        if hasattr(web_config, "debug"):
            ...
            ObjectPool.mode_dev = ws_settings["debug"]
